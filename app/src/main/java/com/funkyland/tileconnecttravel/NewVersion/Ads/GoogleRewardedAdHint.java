...
public class GoogleRewardedAdHint {
    ...
    public GoogleRewardedAdHint(Activity activity) {
...
//        progress.show();
        ...
        RewardedAd.load(activity, activity.getString(R.string.AdUnitId_RewardedAdHint),
