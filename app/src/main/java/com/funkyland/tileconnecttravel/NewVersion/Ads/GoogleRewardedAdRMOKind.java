...
public class GoogleRewardedAdRMOKind {
    ...
    public GoogleRewardedAdRMOKind(Activity activity) {
...
//        progress.show();
        ...
        RewardedAd.load(activity, activity.getString(R.string.AdUnitId_RewardedAdRMOKind),
