...
public class OnclickChecker {
    ...
    public static void checkEat() {
        ...
        if (!(OnclickChecker.item1.getGT_ITEM() != OnclickChecker.item2.getGT_ITEM() ||
                (OnclickChecker.item1.getI() == OnclickChecker.item2.getI() &&
                        OnclickChecker.item1.getJ() == OnclickChecker.item2.getJ()))) {
            ...
            if (checkCondition(i, j, k, l, list)) {
                ...
                if (list.size() < 5) {
                    ...
                    GameMainActivity.mPlay.mDollar.addDollar(5);
...
//                                IPreferences.getInstance(GameMainActivity.mPlay).getIAdShownStatus()) {
//                            GameMainActivity.mPlay.musicBackground.pause();
//                            GoogleRewardedAd googleRewardedAd = new GoogleRewardedAd(GameMainActivity.mPlay);
//
//                            GoogleRewardedAd.setInterfaceInter(new GoogleRewardedAd.OnclickInter() {
//                                @Override
//                                public void clicked() {
//                                    GameMainActivity.mPlay.GameOver = true;
...
//                            });
//
//                            GoogleRewardedAd.setEndedRewardedAd(new GoogleRewardedAd.EndedRewardedAd() {
//                                @Override
