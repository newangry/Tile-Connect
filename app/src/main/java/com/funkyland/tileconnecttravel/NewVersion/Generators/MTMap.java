...
public class MTMap {
    ...
    public static void getTotalRowColumn(int startDollarX, int endDollarY, int hintX) {
        ...
        if (Pereferences.get_gameType().equals(GAME_TYPE_HARD)) {
        ...
        boolean scaleDirection =
                GameHeight * 1.0f / (GameConfiguration.ITEM_HEIGHT * MTMap.row * 1.0f) > GameWidth * 1.0f / (GameConfiguration.ITEM_WIDTH * MTMap.column * 1.0f);
