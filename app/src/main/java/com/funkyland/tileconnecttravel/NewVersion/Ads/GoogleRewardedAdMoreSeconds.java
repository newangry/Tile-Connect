...
public class GoogleRewardedAdMoreSeconds {
    ...
    public GoogleRewardedAdMoreSeconds(Activity activity) {
...
//        progress.show();
        ...
        RewardedAd.load(activity, activity.getString(R.string.AdUnitId_RewardedAdMoreSeconds),
