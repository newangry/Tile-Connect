...
public class SparkelaAdapter extends RecyclerView.Adapter<SparkelaAdapter.MyViewHolder> {
    ...
    public SparkelaAdapter(Context context, Integer[] list, String[] listpath, Integer[] image) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.raw_sparkela, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Pereferences.get_LockTypeStatus(listpath[holder.getAdapterPosition()])) {
                    Pereferences.set_gameType_InSubType(listpath[holder.getAdapterPosition()]);
                    adapterClick.ClickOnItem(position, listpath[holder.getAdapterPosition()]);
                }
            }
        });
    }
